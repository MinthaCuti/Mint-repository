 ...
 * @author huyhk
 */
public class LAB3_BAI3_SD2001_MOB1024_TV00385 {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 7:
                    ...
                    System.out.println("Tong luong: " + service.sumSalary());
                    System.out.println("Luong trung binh: " + service.avgSalary());

                    Employee max = service.maxSalaryEmployee();
                    if (max != null) {
                        System.out.println("Nhan vien luong cao nhat: " + max);
                    }
                    break;
